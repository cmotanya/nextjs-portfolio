...
const MobileNav = ({
  ...
  return (
    ...
    >
      ...
      <button className="absolute bottom-[5.5rem] left-1/2 right-0 w-max -translate-x-1/2 rounded-md bg-secondary-clr px-4 py-3 text-2xl uppercase text-900 dark:bg-neutral-800/50 dark:font-normal dark:text-400 md:hidden">
        <Link
      ...
      <button className="absolute bottom-[10rem] left-1/2 right-0 w-max -translate-x-1/2 rounded-md bg-secondary-clr px-4 py-3 text-2xl uppercase text-900 dark:bg-neutral-800/50 dark:font-normal dark:text-400 md:hidden">
        <Link
          href="./assets/Resume.pdf"
          target="_blank"
          passHref={true}
