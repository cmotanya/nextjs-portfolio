        ...
        {!isSubmitSuccessful && (
          ...
          >
            ...
            <input
              ...
              name="name"
              autoComplete="name"
              className={`rounded-full bg-transparent py-[0.6rem] ps-5 ring-2 ring-500 placeholder:text-500 focus-within:outline-none focus-within:ring-700 dark:py-2 dark:text-400 dark:ring-700 dark:placeholder:text-600 dark:focus-within:ring-500`}
            />
            {errors.name && (
              <span
                role="alert"
                className="-mt-2 text-sm font-semibold text-red-600 dark:text-red-500"
            ...
            <textarea
              ...
              className={`resize-none rounded-md bg-transparent px-5 py-1 ring-2 ring-500 placeholder:text-500 focus-within:outline-none focus-within:ring-700 dark:py-2 dark:text-400 dark:ring-2 dark:ring-700 dark:placeholder:text-600 dark:focus-within:ring-500`}
            />
            {errors.textarea && (
              <span
                role="alert"
