        ...
        {!isSubmitSuccessful && (
          ...
          >
            ...
            <textarea
              ...
              className={`resize-none rounded-sm bg-transparent px-3 py-1 ring-2 ring-500 placeholder:text-500 focus-within:outline-none focus-within:ring-700 dark:py-2 dark:text-400 dark:ring-2 dark:ring-700 dark:placeholder:text-600 dark:focus-within:ring-500`}
            />
            {errors.textarea && (
              <span
                role="alert"
