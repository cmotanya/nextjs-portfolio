    ...
    <section id="skill" className="py-[3rem] text-neutral-300">
      <div className="mx-auto w-[--width]">
        <div className="text-pretty px-6">
          <h1 className="py-3 text-center font-ubuntu text-5xl uppercase md:pt-0">
            projects{" "}
          </h1>
        </div>

        <div className="flex basis-full flex-col justify-center space-y-6 font-quicksand text-lg">
