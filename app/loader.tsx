...
function SkeletonUI() {
  return (
    <div className="relative min-h-dvh border-2 border-transparent">
      {/* navigation loader */}
      <div className=":dark:bg-800 absolute right-3 top-4 h-10 w-10 animate-pulse rounded-md md:right-0 md:top-0 md:h-[5rem] md:w-full md:rounded-none"></div>
      ...
      <div className="mx-auto max-w-4xl px-3">
        ...
        <div className="mt-[5rem] w-3/4 animate-pulse rounded-sm bg-800 xs:h-[2rem] md:mt-[12rem] md:h-[4rem] lg:mt-[6rem] lg:h-0"></div>
        <div className="mt-4 animate-pulse rounded-sm bg-800 xs:h-[11rem] md:h-[18rem] lg:h-0"></div>
      </div>

      {/* loader simulating two button on other devices except medium devices */}
      <div className="absolute bottom-3 left-1/2 mt-[6rem] flex w-full max-w-3xl  -translate-x-1/2 animate-pulse flex-col justify-center px-3 xs:mt-[6rem] md:mt-[3.5rem] md:flex-row md:justify-start">
