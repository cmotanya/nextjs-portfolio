...
function ContactComponent({ icon, text }: { icon: ReactNode; text: string }) {
  return (
    <div className="relative mb-2 ml-10 flex h-12 w-[25ch] items-center gap-4 rounded-md bg-slate-800/50 ps-3 font-semibold text-400 outline-none outline-offset-[3px] outline-slate-800/50 before:absolute before:-left-8 before:top-1/2 before:size-5 before:-translate-x-1/2 before:-translate-y-1/2 before:rounded-full before:bg-rose-800 after:absolute after:-left-8 after:top-1/2 after:size-2 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:bg-gray-900 md:mb-0">
      {icon} {text}
    </div>
  );
}
    ...
    <section id="contact" className="pb-[8rem] pt-[3rem] text-stone-300">
      <div className="mx-auto w-[--width]">
        <div className="text-pretty px-6">
          <h1 className="py-3 text-center font-ubuntu text-5xl font-bold uppercase md:pt-0">
            contact{" "}
          </h1>
        </div>
