...
function Contact() {
  ...
  return (
    <section id="contact" className=" pb-24 font-semibold md:mt-8">
      <h1 className="py-3 text-4xl font-extrabold md:pt-0">Contact </h1>
      <div>
        <h2 className="py-3">
