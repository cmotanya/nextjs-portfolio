...
function Footer() {
  ...
  return (
    <footer className="absolute bottom-0 flex flex-col bg-bright-clr py-1 font-bold dark:bg-800 md:w-[inherit] md:flex-row">
      <div className="relative mx-auto flex flex-wrap gap-2">
        <FooterIcon
      ...
      <div className="mx-auto flex flex-col justify-center text-balance text-center font-quicksand text-sm">
