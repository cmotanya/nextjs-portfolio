...
function Footer() {
  ...
  return (
    <footer className="absolute bottom-0 flex w-full flex-col gap-1 border-t-2 border-primary-clr py-1 font-bold dark:bg-neutral-800/50 md:flex-row">
      ...
      <div className="mx-auto flex flex-col justify-center text-balance text-center font-montserrat text-sm">
        <p className="uppercase leading-normal dark:text-500">
